//Write a program whose major task is to calculate an individual’s Net Salary by getting the inputs of basic salary and benefits. Calculate the payee (i.e. Tax), NHIF Deductions, NSSF Deductions, gross salary, and net salary. //This code calculates an employee of Kenya Net Salary after Paye, NHIF and NSSF Deductions.
...
let basicSalary = getValidNumber("Enter your basic salary:"); 
let benefits = getValidNumber("Enter your benefits:");
let grossSalary = basicSalary + benefits;

console.log(`Your gross salary is: ${grossSalary} Ksh`); 
...
function calculateNhif(grossSalary) {
    ...
    for (let rate of nhifRates) {     
        if (grossSalary <= rate.max) {  
            return grossSalary - rate.deduction;   
        }                                               
    }
}
